      ...
      <div className="container">
        <div className="left">
          <span className="breadcrumbs">
           Mentor-Link / Programming & Tech / Website Development / Literature
          </span>
          <h1>I will help you learn React</h1>
          <div className="user">
          ...
          <div className="gig-description">
            ...
            <p>
              ...
              stunning, functional websites from design concepts. I love mentoring and sharing my insights. My expertise
              includes:
            </p>
            <ul>
              <li>
            ...
            <p>
              ...
              satisfaction. High-quality teaching, tailored to your needs. {"Let's"}
              chat about your need and pricing before starting our web
              journey! 🚀
            </p>
          </div>
          <div className="seller">
            ...
            <div className="box">
              ...
              <p>
                ...
                <br />Dedicated and hardworking, i'm driven by a passion for
              frontend development. Your project is my focus, aiming for your
              satisfaction. High-quality teaching, tailored to your needs. Let's
              chat about your need and pricing before starting our web
              journey! 🚀.
          ...
          <div className="reviews">
            ...
            <div className="item">
              ...
              <p>
                Incredible experience working with this Tutor.
                Their proficiency in ReactJS and design skills truly shine. They
                convered my complex doubts into mastery. The final
            ...
            <div className="item">
              ...
              <p>
                ...
                work!  The attention they paid to detail is outstanding. The end result
                is a trasformed me. A truly
